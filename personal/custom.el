(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (async avy cider clojure-mode dash editorconfig f gh git-commit helm helm-core hydra ido-completing-read+ inflections magit-popup multiple-cursors paredit pcache projectile seq slime spinner with-editor yasnippet rcirc-notify mu4e org-evil zop-to-char zenburn-theme yaml-mode which-key volatile-highlights smex smartrep smartparens smart-mode-line rainbow-mode rainbow-delimiters pkgbuild-mode ov operate-on-number move-text markdown-mode magit key-chord json-mode js2-mode imenu-anywhere helm-projectile helm-descbinds helm-ag guru-mode grizzl god-mode gitignore-mode gitconfig-mode git-timemachine gist geiser flycheck flx-ido expand-region elisp-slime-nav effort-export easy-kill discover-my-major diminish diff-hl csv-mode crux company clj-refactor browse-kill-ring beacon anzu ag)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#181a26" :foreground "gray80" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 115 :width normal :foundry "PfEd" :family "DejaVu Sans Mono")))))
